  ...
  return (
    <main className="bg-[#0f172a] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        >
          <p className="uppercase tracking-[0.5em] text-sky-400 text-sm mb-6">
          ...
          <div className="text-sky-400 text-5xl my-4">
            &
          </div>
          ...
          <button className="mt-10 px-8 py-4 rounded-full bg-sky-500 hover:bg-sky-600 transition">
            View Invitation
          </button>
        </motion.div>
        ...
        <section className="py-24 px-6">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <span className="uppercase tracking-[0.3em] text-sky-400">
                The Couple
              </span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              {[
                ...
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 text-center"
                >
                ...
                {eventData.loveStory.map((story, index) => (
                  ...
                  >
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-sky-400 text-sm uppercase tracking-wider mb-2">
                        {story.subtitle}
                      </p>
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="mt-4 md:mt-0">
                        ...
                        <span className="inline-flex px-5 py-3 rounded-full bg-sky-500 text-white font-semibold">
                          {item.time}
                        </span>
      ...
      {eventData.rsvpEnabled && (
        <section className="py-24 px-6 bg-black/20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-[32px] p-8 md:p-12">
              ...
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button
                    type="button"
                    className="py-4 rounded-2xl bg-green-500 hover:bg-green-600 transition"
                  >
                    Attending
                  </button>
                  ...
                  <button
                    type="button"
                    className="py-4 rounded-2xl bg-red-500 hover:bg-red-600 transition"
                  >
                    Not Attending
                  </button>
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-2xl bg-sky-500 hover:bg-sky-600 transition font-semibold"
                >
                  Submit RSVP
                </button>
              ...
              <div className="bg-white/5 border border-white/10 rounded-[32px] p-10 backdrop-blur-xl">
                ...
                {eventData.mapLink && (
                  <a
                    ...
                    className="inline-flex px-8 py-4 rounded-full bg-sky-500 hover:bg-sky-600 transition"
                  >
                    Open Google Maps
                  </a>
                )}
      ...
      {eventData.musicUrl && (
        <div className="fixed bottom-6 right-6 z-50">
          ...
          <button
            ...
            className="w-16 h-16 rounded-full bg-sky-500 hover:bg-sky-600 text-white text-2xl shadow-2xl transition"
          >
            🎵
          </button>
      ...
      <footer className="py-32 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-4xl md:text-6xl font-bold">
            ...
            <span className="mx-4 text-sky-400">
              &
            </span>
